...
import { OMNIDEF } from './aZSCApplicationSubmissionEnglish_def.js';
import tmpl from './aZSCApplicationSubmissionEnglish.html';
import tmpl_nds from './aZSCApplicationSubmissionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCApplicationSubmissionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
