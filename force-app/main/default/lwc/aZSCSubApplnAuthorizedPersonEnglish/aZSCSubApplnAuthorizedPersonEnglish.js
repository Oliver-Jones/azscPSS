...
import { OMNIDEF } from './aZSCSubApplnAuthorizedPersonEnglish_def.js';
import tmpl from './aZSCSubApplnAuthorizedPersonEnglish.html';
import tmpl_nds from './aZSCSubApplnAuthorizedPersonEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCSubApplnAuthorizedPersonEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
