...
import { OMNIDEF } from './aZSCSubApplnAuthorizedEntityEnglish_def.js';
import tmpl from './aZSCSubApplnAuthorizedEntityEnglish.html';
import tmpl_nds from './aZSCSubApplnAuthorizedEntityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCSubApplnAuthorizedEntityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
