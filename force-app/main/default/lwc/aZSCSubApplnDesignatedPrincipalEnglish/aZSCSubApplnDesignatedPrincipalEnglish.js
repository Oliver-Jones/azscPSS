...
import { OMNIDEF } from './aZSCSubApplnDesignatedPrincipalEnglish_def.js';
import tmpl from './aZSCSubApplnDesignatedPrincipalEnglish.html';
import tmpl_nds from './aZSCSubApplnDesignatedPrincipalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCSubApplnDesignatedPrincipalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
