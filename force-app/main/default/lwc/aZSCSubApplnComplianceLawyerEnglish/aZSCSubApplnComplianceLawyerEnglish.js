...
import { OMNIDEF } from './aZSCSubApplnComplianceLawyerEnglish_def.js';
import tmpl from './aZSCSubApplnComplianceLawyerEnglish.html';
import tmpl_nds from './aZSCSubApplnComplianceLawyerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCSubApplnComplianceLawyerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
