...
import { OMNIDEF } from './aZSCInitialApplicationEnglish_def.js';
import tmpl from './aZSCInitialApplicationEnglish.html';
import tmpl_nds from './aZSCInitialApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aZSCInitialApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
